CardLearner = (function() {
  ...
  CardLearner.prototype.logLearner = function() {
    console.log("Card learner information");
    console.log("========================");
    console.log("N: ", this.N);
    console.log("NBins: ", this.NBins);
    console.log("bin_of_card: ", this.bin_of_card);
    console.log("BinProbs: ", this.BinProbs);
    console.log("cards_in_bin: ", this.cards_in_bin);
  }
